...
def main(argv):
    ...
    training_set_path="/home/yogi/PRCV/project5/greek_train/greek_train"
    greek_train = torch.utils.data.DataLoader(torchvision.datasets.ImageFolder( training_set_path,
    ...
    #Training the Data
    network_trainer(model,greek_train,greek_test,n_epochs,"greek",plot=True)
